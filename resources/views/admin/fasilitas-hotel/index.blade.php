...
@section('content')
    ...
    <h1 class="h3 mb-0 text-gray-800">Fasility Hotels</h1>
    <a href="{{ route('facility-hotels.create') }}" class="btn btn-sm btn-primary shadow-sm"><i
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Fasility Hotels Data</h6>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered" style="font-size:14px;" id="fasilityhotel" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Equipment</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="row justify-content-center">
                                    <div class="col-2  ">
                                        <a href="{{ route('facility-hotels.edit',$item->id) }}"><i class="fas fa-edit " style="color: #f39c12"></i></a>
                                    </div>
                                    <div class="col-2  ">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <form action="{{ route('facility-hotels.destroy',$item->id) }}"method="post">
                                                    @csrf
