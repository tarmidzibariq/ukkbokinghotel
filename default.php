...
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="https://www.hostinger.co.id/" rel="nofollow"><img src="https://cdn.hostinger.com/hostinger_welcome/images/hostinger-logo.png" width="120" alt="Hostinger"></a>
        </div>
        ...
        <div class="footer">
            <div class="row">
                ...
                <div class="copyright text-center">
                    Hostinger © <?php echo date("Y"); ?>. Hak cipta dilindungi.
                </div>
            </div>
        </div>
    </div>
